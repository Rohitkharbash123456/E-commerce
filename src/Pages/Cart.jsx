...
const Cart = () => {
  ...
  const [address, setAddress] = useState('mainstret,0012')
            ...
            <div className='md:w-2/3'>
              ...
              <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
                ...
                <div className='flex justify-between mb-5 border-b pb-1'>
                  <span className='text-sm'>Toatl Items :</span>
                  <span>
                    {cart.totalQuantity}
                  </span>
                </div>
                <div className='mb-4 border-b pb-2'>
                  ...
                  <p className=' text-left ml-2'>Shipping to : { ""}
                  <span className='text-xs font-bold'>{address} </span></p>
                  <button className=' text-left text-blue-500 hover:underline mt-1 ml-2 '
